...
occs <- occ_search(scientificName = species, # we can check other dbs with diff packages
                   limit = 100000)
names(occs)
...
tax.check <- TPL(species.names) # essa funcao TPL é importante
...
geo.clean <- clean_coordinates(x = myrsine.coord, # esse aqui tbm
...
# Now, how do you do this with tmap?
